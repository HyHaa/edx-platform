...
class LocMapperStore(object):
    ...
    def translate_location_to_course_locator(self, old_style_course_id, location, published=True):
        ...
        course_locator = CourseLocator(package_id=entry['course_id'], branch=branch)
        self._cache_course_locator(old_style_course_id, course_locator)
    ...
    def _get_course_locator_from_cache(self, old_course_id):
        """
        ...
        if entry is not None:
            ...
            return entry.as_course_locator()
    ...
    def _cache_course_locator(self, old_course_id, course_locator):
        """
        For quick lookup of courses
        """
        self.cache.set(old_course_id, {old_course_id: course_locator})
