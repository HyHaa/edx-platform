...
class TestPasswordPolicy(LoginEnrollmentTestCase):
    ...
    def test_bad_password_length(self):
        ...
        self.assertEqual(data['value'], "Invalid Length (Must be 6 characters or more)")
    ...
    def test_password_sequence(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['value'], "Based on a common sequence of characters")
    ...
    def test_enough_upper_case_letters(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['value'], "Must be more complex (Must contain 3 or more uppercase characters)")
    ...
    def test_enough_lower_case_letters(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['value'], "Must be more complex (Must contain 3 or more lowercase characters)")
    ...
    def test_enough_digits(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['value'], "Must be more complex (Must contain 3 or more digits)")
    ...
    def test_enough_punctuations(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['value'], "Must be more complex (Must contain 3 or more punctuation characters)")
    ...
    def test_enough_words(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['value'], "Must be more complex (Must contain 3 or more unique words)")
    ...
    def test_dictionary_similarity(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['value'], "Based on a dictionary word.")
